"""
Django settings for djangoRequerimientos project.
...
ROOT_URLCONF = 'djangoRequerimientos.urls'
...
WSGI_APPLICATION = 'djangoRequerimientos.wsgi.application'
